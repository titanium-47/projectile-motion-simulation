...
void Simulate(double time, int resolution, double velocity, double angle, double area, double dragCoefficient, double mass) {
    _time = time;
...
EMSCRIPTEN_BINDINGS(projectile_motion) {
    ...
    function("getX", &getX);
    function("getY", &getY);
    function("getMaxHieght", &getMaxHieght);
    function("getMaxLength", &getMaxLength);
}
